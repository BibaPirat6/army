...
@section('content')
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div class="bg-white rounded-2xl shadow-xl p-6">
            <h1 class="text-2xl font-bold text-gray-800 mb-2">Новая подзадача</h1>
            <p class="text-sm text-gray-500 mb-6">Для задачи: <span class="font-medium text-indigo-600">{{ $task->title }}</span></p>

            <form action="{{ route('calendar.tasks.subtasks.store', $task) }}" method="POST">
                @csrf
                ...
                <div class="grid grid-cols-3 gap-4 mb-6">
                    <div>
                        ...
                        <input type="number" name="min_time_minutes" value="{{ old('min_time_minutes', 0) }}" required min="0"
                            class="w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    ...
                    <div>
                        ...
                        <input type="number" name="avg_time_minutes" value="{{ old('avg_time_minutes', 0) }}" required min="0"
                            class="w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    ...
                    <div>
                        ...
                        <input type="number" name="max_time_minutes" value="{{ old('max_time_minutes', 0) }}" required min="0"
                            class="w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
