...
@section('content')
    ...
    <div class="max-w-2xl p-6 mx-auto">
        ...
        <div class="mb-8">
            ...
            <p class="text-[#565A5B] mt-1">Заполните все необходимые поля для редактирования штатной должности</p>
        </div>

        <!-- Форма -->
        <div class="bg-[#e7e1e1] rounded-2xl shadow-lg border border-[#BFBFBF] overflow-hidden">
            <div class="p-6 md:p-8">
                <form action="{{ route('commissariat-positions.update', $commissariatPosition->id) }}" method="POST" class="space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="relative">
                        ...
                        <input type="text" id="department_search" placeholder="Выберите отдел"
                            ...
                            autocomplete="off"
                            value="{{ old('department_id', $commissariatPosition->department_id ? $commissariatPosition->department->name : '') }}">

                        <input type="hidden" name="department_id" id="department_id2"
                            value="{{ old('department_id', $commissariatPosition->department_id) }}">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" id="division_search" placeholder="Выберите отделение"
                            class="w-full px-4 py-3 bg-white border border-[#BFBFBF] rounded-lg
                                                                                  ...
                                                                                  outline-none transition-colors text-[#060606]" 
                            autocomplete="off" 
                            value="{{ old('division_id', $commissariatPosition->division_id ? $commissariatPosition->division->name : '') }}">

                        <input type="hidden" name="division_id" id="division_id2"
                            value="{{ old('division_id', $commissariatPosition->division_id) }}">
                    ...
                    <div class="relative">
                        ...
                        <input required type="text" id="position_search" placeholder="Выберите должность" 
                            class="w-full px-4 py-3 bg-white border border-[#BFBFBF] rounded-lg
                                                                  ...
                                                                  outline-none transition-colors text-[#060606]"
                            autocomplete="off"
                            value="{{ old('position_id', $commissariatPosition->position_id ? $commissariatPosition->position->name : '') }}">

                        <input type="hidden" name="position_id" id="position_id"
                            value="{{ old('position_id', $commissariatPosition->position_id) }}">
                    ...
                    <div>
                        ...
                        <input required type="number" class="w-full px-4 py-3 bg-white border border-[#BFBFBF] rounded-lg
                                                              focus:ring-2 focus:ring-[#A60644] focus:border-[#A60644]
                                                              outline-none transition-colors text-[#060606]"
                            autocomplete="off" placeholder="Введите общую ставку" 
                            value="{{ old('rate_total', $commissariatPosition->rate_total) }}" 
                            min="0.25" max="2.00" step="0.25" name="rate_total">
                    </div>
                    ...
                    <div>
                        ...
                        <select name="is_independent" id="is_independent"
                            ...
                            <option value="0" {{ old('is_independent', $commissariatPosition->is_independent) == 0 ? 'selected' : '' }}>Нет</option>
                            <option value="1" {{ old('is_independent', $commissariatPosition->is_independent) == 1 ? 'selected' : '' }}>Да</option>
                        </select>
                    </div>
