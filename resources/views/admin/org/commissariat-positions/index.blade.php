                    ...
                    <tbody class="divide-y divide-[#BFBFBF]">
                        @forelse($commissariatPositions as $pos)
                            <tr class="hover:bg-[#A60644]/5 transition-colors duration-200">
                                ...
                                <td class="px-6 py-4">
                                    <div class="space-y-1">
                                        <div class="text-sm">
                                            ...
                                            <span class="text-[#A60644] font-bold">{{ number_format($pos->rate_total, 2) }}</span>
                                        </div>
                                        <div class="text-sm">
                                            <span class="font-medium">Занято:</span> 
                                            <span class="text-green-600 font-bold">{{ number_format($pos->occupied_rate, 2) }}</span>
                                        </div>
                                        <div class="text-sm">
                                            <span class="font-medium">Свободно:</span> 
                                            <span class="{{ $pos->has_vacancy ? 'text-blue-600' : 'text-red-600' }} font-bold">
                                        ...
                                        <div class="w-full bg-gray-200 rounded-full h-1.5 mt-2">
                                            @php
                                                $percent = $pos->rate_total > 0 ? ($pos->occupied_rate / $pos->rate_total) * 100 : 0;
                                            @endphp
                                            <div class="bg-[#A60644] h-1.5 rounded-full" style="width: {{ $percent }}%"></div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4">
                                    @if($pos->has_vacancy)
                                        <div class="inline-flex items-center px-2 py-1 rounded-md bg-blue-100 text-blue-800 text-sm font-medium">
                                    ...
                                    @else
                                        <div class="inline-flex items-center px-2 py-1 rounded-md bg-green-100 text-green-800 text-sm font-medium">
                                            <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <tr>
                                <td colspan="5" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <p class="text-sm text-[#565A5B] mt-2">Создайте первую штатную должность для этого комиссариата</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
