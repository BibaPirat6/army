...
@section('content')
    ...
    <div class="max-w-2xl p-6 mx-auto">
        ...
        <div class="mb-8">
            ...
            <h1 class="text-2xl font-bold text-[#060606]">Создание типа должности</h1>
            <p class="text-[#565A5B] mt-1">Заполните все необходимые поля для создания нового типа должности</p>
        </div>
