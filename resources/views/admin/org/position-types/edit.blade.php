...
@section('content')
    ...
    <div class="max-w-2xl p-6 mx-auto">
        ...
        <div class="mb-8">
            ...
            <h1 class="text-2xl font-bold text-[#060606]">Редактирование типа должности</h1>
            <p class="text-[#565A5B] mt-1">Редактирование типа должности: "{{ $type->name }}"</p>
        </div>

        <!-- Форма -->
        <div class="bg-[#e7e1e1] rounded-2xl shadow-lg border border-[#BFBFBF] overflow-hidden">
            <div class="p-6 md:p-8">
                <form action="{{ route('position-types.update', $type->id) }}" method="POST" class="space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div>
                        ...
                        <input type="text" name="name" id="name" placeholder="Введите название типа"
