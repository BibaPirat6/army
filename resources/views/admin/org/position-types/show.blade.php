            ...
            <div class="p-6 md:p-8">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center justify-between py-3 border-b border-[#BFBFBF] last:border-b-0">
                        ...
                        <span
                            class="text-[#060606]">{{ \Carbon\Carbon::parse($type['created_at'])->format('d.m.Y H:i') }}</span>
                    </div>

                    <div class="flex items-center justify-between py-3 border-b border-[#BFBFBF] last:border-b-0">
                        <span class="font-medium text-[#565A5B]">Обновлен</span>
                        <span
                            class="text-[#060606]">{{ \Carbon\Carbon::parse($type['updated_at'])->format('d.m.Y H:i') }}</span>
                    </div>
                </div>
            </div>
        </div>
