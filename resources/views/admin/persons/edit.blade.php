...
@section('content')
    ...
    <div class="max-w-2xl mx-auto p-6">
        ...
        <div class="mb-8">
            ...
            <h1 class="text-2xl font-bold text-[#060606]">Персональные данные {{ $person->last_name }}
                {{ $person->first_name }} {{ $person->patronymic }}</h1>
            <p class="text-[#565A5B] mt-1">Редактирование персональных данных сотрудника</p>
        </div>
