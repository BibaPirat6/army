...
@section('content')
    ...
    <div class="max-w-2xl mx-auto p-6">
        ...
        <div class="mb-8">
            ...
            <h1 class="text-2xl font-bold text-[#060606]">Редактировать статус</h1>
            <p class="text-[#565A5B] mt-1">Редактирование рабочего статуса: "{{ $status->description }}"</p>
        </div>

        <!-- Форма -->
        <div class="bg-[#e7e1e1] rounded-2xl shadow-lg border border-[#BFBFBF] overflow-hidden">
            <div class="p-6 md:p-8">
                <form action="{{ route('work-statuses.update', $status->id) }}" method="post" class="space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div>
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name', $status->name) }}"
                            required placeholder="Введите название на английском"
