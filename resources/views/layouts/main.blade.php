...
<nav class="navigation fixed top-0 left-0 right-0 z-[900] bg-[#e7e1e1] border-b border-[#BFBFBF] shadow-lg">
    <div class="flex flex-wrap items-center justify-between px-3 xl:px-5 py-2 xl:py-3">
        ...
        <button id="burger-btn" class="burger-btn text-[#060606] hover:text-[#A60644] focus:outline-none p-1">
            <svg id="burger-icon" class="w-5 h-5 xl:w-6 xl:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16"/>
            </svg>
            <svg id="close-icon" class="w-5 h-5 xl:w-6 xl:h-6 hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            @if (auth()->check() && auth()->user()->role?->name === 'admin')
                <li>
                    <a href="{{ route('persons-columns.index') }}"
                        ...
                        <svg class="w-5 h-5 flex-shrink-0 text-[#A60644]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <li class="relative">
                    <button type="button"
                        ...
                        <svg class="w-4 h-4 transition-transform duration-300 dropdown-arrow flex-shrink-0" fill="none"
        ...
        <ul id="mobile-nav" 
            ...
            @if (auth()->check() && auth()->user()->role?->name === 'admin')
                ...
                <li class="relative">
                    ...
                    <ul class="dropdown-menu mt-1 bg-[#e7e1e1] border border-[#BFBFBF] rounded-lg shadow-xl list-none m-0 p-2 z-[1000]
                               hidden opacity-0 scale-95 transition-all duration-200">
                        <li class="mb-1 last:mb-0">
                            <a href="{{ route('commissariats.index') }}"
                                class="block px-4 py-2 text-[#060606] rounded-lg transition-all duration-200 hover:bg-[#A60644]/10 hover:text-[#A60644] hover:pl-5 flex items-center gap-2">
